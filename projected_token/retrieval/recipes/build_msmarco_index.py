#!/usr/bin/env python3
"""Build MS MARCO index using DistillationProjector."""
...
def load_corpus(path: str, limit: int = None):
    docs = []
...
def main():
    parser = argparse.ArgumentParser(description="Build MS MARCO index with DistillationProjector")
    
    parser.add_argument("--corpus-path", default="/data/huggingface/Tevatron/msmarco-passage-corpus/corpus.jsonl.gz")
    ...
    parser.add_argument("--output-dir", default="/data/msmarco_index_distillation")
    ...
    corpus = load_corpus(args.corpus_path, limit=args.limit)
