...
docker exec "$CONTAINER" bash -lc "tmux kill-session -t stage_b_e3_5ep_beir5_resume >/dev/null 2>&1 || true"
...
run_one "E3" "configs/training/e3_5ep_beir5_resume_stage2.yaml" "stage_b_e3_5ep_beir5_resume" "0,1,2,3" "cuda:0" "cuda:1" "cuda:2" "cuda:3"
